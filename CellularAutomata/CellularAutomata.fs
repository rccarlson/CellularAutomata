...
type StateTransform<'TState,'TNeighborhood> = 'TState -> 'TNeighborhood -> 'TState
...
let getNextBoard
  (board:Board<'TState>)
  (getNextState: StateTransform<'TState,'TNeighborhood>)
  ...
  : Board<'TState> =
    ...
    let getNextState x y : 'TState =
      ...
      getNextState currentValue neighborhood
